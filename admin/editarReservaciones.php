...
$consulta = "SELECT reservaciones.id_reservacion,reservaciones.checkin,reservaciones.checkout,
		reservaciones.estado,reservaciones.num_adu,reservaciones.num_niñ,reservaciones.id_cliente,reservaciones.habitacion,
		 clientes.nombre_cli as Cliente,habitaciones.nombre as Habitacion, tipohabitacion.nombre as nombret,
					...
					<form action="editarReservacion.php?idres=<?php echo $idres;?>&IH=<?php echo $IH; ?>" method="post" id="formClientes" class="formClientes">
						<fieldset id="ocultos">
	 					...
	 					<fieldset id="datosCliente">
							...
							<p>Número de niños</p>
							<span></span>
							<input type="text" id="" name="num_niñ" placeholder="Numero de Niños" class="span3" value="<?php echo $num_ni; ?>" />
							<p>Cliente</p>
							<span></span>
