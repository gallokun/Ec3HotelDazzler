		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="span12">
					<br />
					<br />
					<h1 style="color:red"><b>Servicios</b></h1>

					<div class="row">

						<div class="span6">
							<h3><span>Restaurant</span>-Bar</h3>
							<a href="index.php"><img src="css/images/facilities/restaurant.jpg" alt="" /></a>
							<p>
							El restaurante-bar del hotel ofrece un menú variado que incluye opciones para todos los gustos y preferencias, desde platos locales e internacionales hasta aperitivos ligeros y cócteles exquisitos. Además de la comida y las bebidas, el ambiente del restaurante-bar está diseñado para brindar una experiencia memorable, con decoración elegante y cómoda, música ambiental agradable y un servicio atento y profesional.	
							</p>
						</div>

						<div class="span6">
							<h3><span>Spa </span> &amp; Massage</h3>
							<a href="index.php"><img src="css/images/facilities/massage.jpg" alt="" /></a>
							<p>
							Nuestro hotel ofrece a nuestros huéspedes el exclusivo servicio de Spa y Masajes en nuestras instalaciones, diseñado para proporcionar una experiencia de relajación y rejuvenecimiento incomparable durante su estancia. 
							</p>
						</div>
